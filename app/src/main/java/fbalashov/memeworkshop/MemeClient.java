...
public class MemeClient {
  ...
  private String getMemeLink(String imageId, Response response) throws JSONException, IOException {
    JSONObject object = new JSONObject(response.body().string());
    JSONArray array = object.getJSONArray("data");
    JSONObject memeData = array.getJSONObject(Integer.parseInt(imageId));
    return memeData.getString("link");
  }
}
